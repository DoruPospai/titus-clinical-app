...
def compute_age_factor_v2(
    ...
    age = _f(age_months)
    if math.isnan(age):
        return {"AgeFactor": 1.0, "HardExclusion": False, "Layer": "no_age", "RawFactor": np.nan}
    ...
    if evidence == "insufficient" or weight == 0.0:
        return {"AgeFactor": 1.0, "HardExclusion": False, "Layer": "insufficient", "RawFactor": np.nan}
    ...
    if not raw_values:
        return {"AgeFactor": 1.0, "HardExclusion": False, "Layer": "no_valid_peak", "RawFactor": np.nan}
